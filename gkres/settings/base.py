""" Django settings for gkres project.
...
CSRF_TRUSTED_ORIGINS = ['https://gkres.ru', 'https://*.gkres.ru']
...
WSGI_APPLICATION = "gkres.wsgi.application"
...
# убирает сообщение об обновлении
